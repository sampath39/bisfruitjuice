...
const FALLBACK_PRODUCTS = [
  ...
  // Cool Drinks
  { id: 'd1', name: 'Thums Up 250ml', description: 'Strong, carbonated fizzy cola drink. Served ice cold.', price: 20.00, category: 'Cool Drinks', image_url: 'https://m.media-amazon.com/images/I/51v1zV1PIfL._SX679_.jpg', is_available: true },
  { id: 'd2', name: 'Sprite 750ml', description: 'Crisp, refreshing lemon-lime soda. Chill bottle.', price: 45.00, category: 'Cool Drinks', image_url: 'https://m.media-amazon.com/images/I/51wXQZ-Q5LL._SX679_.jpg', is_available: true },
  { id: 'd3', name: 'Coca Cola 1.25L', description: 'Classic fizzy sweet cola drink. Perfect party size.', price: 70.00, category: 'Cool Drinks', image_url: 'https://m.media-amazon.com/images/I/61S4hHwO0-L._SX679_.jpg', is_available: true },
  // Water Bottles
  { id: 'w1', name: 'Bisleri Mineral Water 1L', description: 'Safe, purified packaged drinking mineral water.', price: 20.00, category: 'Water Bottles', image_url: 'https://m.media-amazon.com/images/I/41D5R-hQ+8L._SX679_.jpg', is_available: true },
  { id: 'w2', name: 'Kinley Drinking Water 1L', description: 'Double purified bottled water with added minerals.', price: 20.00, category: 'Water Bottles', image_url: 'https://m.media-amazon.com/images/I/41t6f1x4VpL._SX679_.jpg', is_available: true },
  // Ice Creams
  ...
  // Cigarettes
  { id: 'c1', name: 'Classic Milds', description: 'Premium rich blend cigarettes. Pack of 20.', price: 190.00, category: 'Cigarettes', image_url: 'https://upload.wikimedia.org/wikipedia/commons/1/1b/Classic_Milds_packet.jpg', is_available: true },
  { id: 'c2', name: 'Gold Flake Kings', description: 'Smooth, golden-cured premium tobacco cigarettes. Pack of 20.', price: 180.00, category: 'Cigarettes', image_url: 'https://upload.wikimedia.org/wikipedia/commons/e/ec/Gold_Flake_Kings_packet.jpg', is_available: true },
  { id: 'c3', name: 'Marlboro Advance', description: 'Advanced smooth filter cigarettes. Pack of 20.', price: 200.00, category: 'Cigarettes', image_url: 'https://upload.wikimedia.org/wikipedia/commons/1/15/Marlboro_Advance_pack.jpg', is_available: true }
];
